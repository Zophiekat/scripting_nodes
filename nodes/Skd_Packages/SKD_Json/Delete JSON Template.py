...
class SN_SKD_DeleteJsonTemplate(SN_ScriptingBaseNode, bpy.types.Node):
    bl_idname = "SN_SKD_DeleteJsonTemplate"
    bl_label = "Json Delete Template"
    ...
    def evaluate(self, context):
        ...
        self.code_imperative = """
            def delete_json_template(template_name, filename):
        ...
        self.code = f"delete_json_template({template_name}, {self.inputs[1].python_value})"
